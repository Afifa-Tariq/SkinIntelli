...
extension VerifyEmailScreenWidgets on _SkinIntelAppState {
  Widget _verifyEmailScreen() {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                ...
                if (resendTimer > 0)
                  ...
                  GestureDetector(
                    onTap: () async {
                      final res = await ApiService.resendOtp(registeredEmail);
            ...
            const Spacer(),
            ElevatedButton(
              onPressed: isLoading ? null : _submitVerifyOtp,
